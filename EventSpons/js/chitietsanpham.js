...
// thực hiện chạy các hàm  bên trong
window.onload = function() {
        phanTich_URL_chiTietSanPham();
        khoiTao();
        // gợi ý cho khung tim kiếm
...
function khongTimThaySanPham() {
    // kh tìm thấy hiện phàn tử có id này lên
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Khởi động thư viện hỗ trợ banner - chỉ chạy sau khi tạo xong hình nhỏ chạy slide
