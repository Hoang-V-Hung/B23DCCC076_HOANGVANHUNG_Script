...
function addProductToTable(user) {
    ...
    s += `
            <tr style="font-weight:bold; text-align:center">
                <td colspan="4"></td>
                <td class="thanhtoan" onclick="thanhToan()">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScIRpVa4irRlRwcMy9hnmyh6fDpLVlGiAzeGLuOJebAda-S8Q/viewform" target="_blank"> Xác nhận </a>
                </td>
            </tr>
        </tbody>
    `;
