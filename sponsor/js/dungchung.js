        ...
        <section>    
            <div id="containerFooter">
                <div class="copy-right">
                    <div style="margin-bottom: 10px; max-width: 100dvw; overflow: hidden;">
                        <div>
                            <span>
                                Hotline
                            </span>
                        ...
                        <div>
                            <span>
                                133 Nguyễn Văn Trỗi, Mộ Lao, Hà Đông, T.P Hà Nội
                            </span>
                        </div>
                    </div>
                </div>
        ...
        s.innerHTML = `
			(function () {
				...
				for (var li of li_s) {
					...
					switch (loai) {
						case "Màn hình:":
							result.detail.time = giatri.replace('"', "'");
							break;
						case "Hệ điều hành:":
							result.detail.place = giatri;
							break;
						case "Dung lượng pin:":
